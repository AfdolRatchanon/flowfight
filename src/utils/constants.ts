...
export const LEVELS = [
  ...
  // ── PHASE 9: ปวส. — ADVANCED ALGORITHM ────────────────────────────────────
  {
    id: 'level_21', number: 21,
    name: 'Nested Decisions',
    description: 'ปวส. ด่านที่ 1 — เขียน if/else ซ้อนกัน 2 ชั้น จัดการ Ailment + HP พร้อมกัน',
    difficultyEstimate: 5,
    concept: 'Nested Conditional (if inside if)',
    tutorialText: 'Spider Queen วาง Poison ทุกรอบ! ต้องตรวจ Poisoned? → ถ้าใช่ Heal → ถ้าไม่ใช่ ตรวจ HP < 40%? → Dodge หรือ Attack — นี่คือ Nested if/else ซ้อนกัน 2 ชั้น!',
    objectives: ['สังหาร Spider Queen', 'ใช้ Condition ซ้อนกัน 2 ชั้น'],
    bonusObjective: 'HP เหลือมากกว่า 30%',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hero_poisoned', 'hp_less'],
    requiredBlocks: ['condition', 'enemy_alive', 'hero_poisoned', 'hp_less'],
    enemy: {
      id: 'spider_queen', name: 'Spider Queen', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 480, currentHP: 480, attack: 38, defense: 18, speed: 14, armor: 10, parry: 22, enrageThreshold: 35, ailmentType: 'poison', ailmentChance: 0.60 },
      behaviors: ['poison_strike', 'attack', 'poison_strike', 'cast_spell', 'attack', 'poison_strike'],
    },
    unlockRequirements: { levelRequired: 20, previousLevelComplete: true },
    rewards: { experience: 3500, gold: 500 },
  },

  {
    id: 'level_22', number: 22,
    name: 'Counter Intelligence',
    description: 'ปวส. ด่านที่ 2 — ผสม Turn Counter + HP Threshold ใน Loop เดียวกันให้ถูกลำดับ',
    difficultyEstimate: 5,
    concept: 'Multi-Condition Loop (Turn + HP combined)',
    tutorialText: 'Stone Golem Armor สูงมาก! ต้องใช้ Loop: Turn ≥ 3? → Power Strike / HP < 30%? → Dodge ก่อน / ปกติ Attack — ผสม Counter + HP ใน Loop เดียวให้ถูกลำดับ!',
    objectives: ['สังหาร Stone Golem', 'ใช้ Turn + HP Condition ใน Loop เดียวกัน'],
    bonusObjective: 'จบภายใน 8 turns',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hp_less', 'turn_gte'],
    requiredBlocks: ['condition', 'enemy_alive', 'hp_less', 'turn_gte', 'power_strike'],
    enemy: {
      id: 'stone_golem', name: 'Stone Golem', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 550, currentHP: 550, attack: 42, defense: 25, speed: 5, armor: 20, parry: 30, enrageThreshold: 50, ailmentType: '', ailmentChance: 0 },
      behaviors: ['attack', 'power_strike', 'attack', 'attack', 'power_strike', 'attack'],
    },
    unlockRequirements: { levelRequired: 21, previousLevelComplete: true },
    rewards: { experience: 3800, gold: 540 },
  },

  {
    id: 'level_23', number: 23,
    name: 'Tri-Ailment Dragon',
    description: 'ปวส. ด่านที่ 3 — มังกรสลับ Burn/Poison/Freeze ต้องตรวจและรับมือ 3 Ailment พร้อมกัน',
    difficultyEstimate: 5,
    concept: 'Multi-Ailment Handling (All 3 types)',
    tutorialText: 'Dragon สลับ Ailment ทุก 2 รอบ! ต้องมี Condition สำหรับ Burning + Poison + Freeze แยกกัน — ถ้าขาด Ailment ไหน Dragon จะ Shield ทำ damage ไม่ได้!',
    objectives: ['สังหาร Tri-Element Dragon', 'ตรวจ Ailment ทั้ง 3 ประเภทใน Flowchart'],
    bonusObjective: 'HP เหลือมากกว่า 20%',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hero_burning', 'hero_poisoned', 'hero_frozen'],
    requiredBlocks: ['condition', 'enemy_alive', 'hero_burning', 'hero_poisoned', 'hero_frozen'],
    enemy: {
      id: 'tri_dragon', name: 'Tri-Element Dragon', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 600, currentHP: 600, attack: 44, defense: 22, speed: 12, armor: 12, parry: 25, enrageThreshold: 40, ailmentType: 'burn', ailmentChance: 0.50 },
      behaviors: ['burn_strike', 'attack', 'poison_strike', 'attack', 'freeze_strike', 'cast_spell', 'attack'],
    },
    unlockRequirements: { levelRequired: 22, previousLevelComplete: true },
    rewards: { experience: 4200, gold: 580 },
  },

  {
    id: 'level_24', number: 24,
    name: 'Skill Optimizer',
    description: 'ปวส. ด่านที่ 4 — ใช้ Class Skill ใน Timing ที่ถูกต้องเพื่อเจาะ Armor สูง',
    difficultyEstimate: 5,
    concept: 'Class Skill Timing Optimization',
    tutorialText: 'Iron Colossus มี Armor สูงมาก! Attack ธรรมดาแทบไม่ได้ผล ต้องใช้ Class Skill ใน timing ที่ถูกต้อง: Turn ≥ 3 → Class Skill / HP < 25% → Heal เพื่อรอ burst อีกครั้ง!',
    objectives: ['สังหาร Iron Colossus', 'ใช้ Class Skill ใน Flowchart'],
    bonusObjective: 'ใช้ Class Skill 3 ครั้งขึ้นไป',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hp_less', 'turn_gte'],
    requiredBlocks: ['condition', 'enemy_alive', 'turn_gte'],
    enemy: {
      id: 'iron_colossus', name: 'Iron Colossus', spriteId: 'enemy_boss',
      budgetPerTurn: 2,
      stats: { maxHP: 620, currentHP: 620, attack: 45, defense: 30, speed: 4, armor: 28, parry: 35, enrageThreshold: 50, ailmentType: '', ailmentChance: 0 },
      behaviors: ['attack', 'power_strike', 'attack', 'attack', 'power_strike', 'power_strike'],
    },
    unlockRequirements: { levelRequired: 23, previousLevelComplete: true },
    rewards: { experience: 4500, gold: 620 },
  },

  {
    id: 'level_25', number: 25,
    name: 'Priority Protocol',
    description: 'ปวส. ด่านที่ 5 — เรียงลำดับ Condition ให้ถูกต้อง (Priority Queue Algorithm)',
    difficultyEstimate: 5,
    concept: 'Condition Priority Ordering',
    tutorialText: 'Chaos Mage สุ่ม Ailment ทุกรอบ! ลำดับ Condition สำคัญมาก: Frozen → Dodge ก่อนเสมอ → Poisoned → Heal → HP < 30% → Dodge → Attack — ลำดับผิดแม้แต่ขั้นเดียวจะพ่ายแพ้!',
    objectives: ['สังหาร Chaos Mage', 'เรียง Condition Priority ให้ถูกต้อง'],
    bonusObjective: 'HP ไม่ต่ำกว่า 40% ตลอดการต่อสู้',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hero_burning', 'hero_poisoned', 'hero_frozen', 'hp_less'],
    requiredBlocks: ['condition', 'enemy_alive', 'hero_frozen', 'hero_poisoned', 'hp_less'],
    enemy: {
      id: 'chaos_mage', name: 'Chaos Mage', spriteId: 'enemy_lich',
      budgetPerTurn: 3,
      stats: { maxHP: 580, currentHP: 580, attack: 48, defense: 20, speed: 16, armor: 8, parry: 20, enrageThreshold: 35, ailmentType: 'freeze', ailmentChance: 0.45 },
      behaviors: ['freeze_strike', 'cast_spell', 'poison_strike', 'attack', 'burn_strike', 'cast_spell', 'freeze_strike'],
    },
    unlockRequirements: { levelRequired: 24, previousLevelComplete: true },
    rewards: { experience: 4800, gold: 660 },
  },

  {
    id: 'level_26', number: 26,
    name: 'Infinite Regress',
    description: 'ปวส. ด่านที่ 6 — Hydra ฟื้น HP ออกแบบ Loop ที่มี Exit Condition 2 เงื่อนไข',
    difficultyEstimate: 5,
    concept: 'Dual Exit Condition Loop',
    tutorialText: 'Ancient Hydra ฟื้น HP เมื่อ HP < 50%! ต้องออกแบบ Loop ที่มี 2 exit: enemy_alive (ตายแล้ว) + turn_gte (burst ทันทีเมื่อถึง turn) เพราะ Hydra ฟื้นเรื่อยถ้าไม่ burst!',
    objectives: ['สังหาร Ancient Hydra', 'ใช้ Dual Exit Condition ใน Loop'],
    bonusObjective: 'จบภายใน 10 turns',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hp_less', 'turn_gte'],
    requiredBlocks: ['condition', 'enemy_alive', 'turn_gte', 'power_strike'],
    enemy: {
      id: 'hydra', name: 'Ancient Hydra', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 700, currentHP: 700, attack: 46, defense: 22, speed: 10, armor: 15, parry: 25, enrageThreshold: 50, ailmentType: 'poison', ailmentChance: 0.35 },
      behaviors: ['attack', 'heal', 'attack', 'power_strike', 'heal', 'attack', 'cast_spell', 'heal'],
    },
    unlockRequirements: { levelRequired: 25, previousLevelComplete: true },
    rewards: { experience: 5200, gold: 700 },
  },

  {
    id: 'level_27', number: 27,
    name: 'Enrage Protocol',
    description: 'ปวส. ด่านที่ 7 — Berserker God โกรธเมื่อ HP < 40% โจมตีแรงขึ้น 2 เท่า',
    difficultyEstimate: 5,
    concept: 'Enemy State Change Response (Enrage)',
    tutorialText: 'Berserker God จะ Enrage เมื่อ HP < 40%! ก่อนถึง Enrage ต้องเตรียมรับมือ: HP < 30%? → Dodge + Class Skill เพื่อ finish ให้เร็วที่สุด — อย่าให้มันโจมตีในสภาวะ Enrage นาน!',
    objectives: ['สังหาร Berserker God', 'รับมือกับ Enrage phase ได้'],
    bonusObjective: 'HP เหลือมากกว่า 15%',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hp_less', 'turn_gte', 'hero_poisoned'],
    requiredBlocks: ['condition', 'enemy_alive', 'hp_less', 'dodge'],
    enemy: {
      id: 'berserker_god', name: 'Berserker God', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 650, currentHP: 650, attack: 52, defense: 20, speed: 14, armor: 12, parry: 20, enrageThreshold: 40, ailmentType: 'burn', ailmentChance: 0.30 },
      behaviors: ['attack', 'power_strike', 'attack', 'burn_strike', 'power_strike', 'attack', 'power_strike'],
    },
    unlockRequirements: { levelRequired: 26, previousLevelComplete: true },
    rewards: { experience: 5600, gold: 740 },
  },

  {
    id: 'level_28', number: 28,
    name: 'Efficiency Challenge',
    description: 'ปวส. ด่านที่ 8 — ออกแบบ Flowchart ที่ใช้ Node น้อยที่สุดแต่ยังชนะได้',
    difficultyEstimate: 5,
    concept: 'Algorithm Efficiency (Minimal Nodes)',
    tutorialText: 'Time Witch สาปให้ budget ลด 1 ถ้า Flowchart มี Node เกิน 12! ต้องออกแบบ Algorithm กระชับ: Loop + Condition เดียวที่ครอบคลุมทุกสถานการณ์ — คิดให้รอบคอบก่อนวาง!',
    objectives: ['สังหาร Time Witch', 'ชนะด้วย Flowchart ที่มีประสิทธิภาพ'],
    bonusObjective: 'ใช้ Node ไม่เกิน 10 Nodes',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hp_less', 'hero_frozen', 'hero_poisoned'],
    requiredBlocks: ['condition', 'enemy_alive'],
    enemy: {
      id: 'time_witch', name: 'Time Witch', spriteId: 'enemy_lich',
      budgetPerTurn: 3,
      stats: { maxHP: 580, currentHP: 580, attack: 50, defense: 24, speed: 18, armor: 10, parry: 28, enrageThreshold: 45, ailmentType: 'freeze', ailmentChance: 0.50 },
      behaviors: ['freeze_strike', 'cast_spell', 'attack', 'freeze_strike', 'power_strike', 'cast_spell', 'freeze_strike', 'attack'],
    },
    unlockRequirements: { levelRequired: 27, previousLevelComplete: true },
    rewards: { experience: 6000, gold: 800 },
  },

  {
    id: 'level_29', number: 29,
    name: "The Architect's Trial",
    description: 'ปวส. ด่านที่ 9 — Sub-Boss สุดท้าย ต้องใช้ทุก Condition Type ที่มีในเกม',
    difficultyEstimate: 5,
    concept: 'Complete Algorithm: All Conditions',
    tutorialText: 'Ancient Dragon ใช้ทุกอย่าง! Flowchart ต้องครบ: Loop (enemy_alive) + HP + Ailment ทั้ง 3 + Counter — ขาดส่วนไหน Dragon จะ Shield ทำ damage ไม่ได้เลย!',
    objectives: ['สังหาร Ancient Dragon', 'ใช้ Condition ทุกประเภทใน Flowchart'],
    bonusObjective: 'HP เหลือมากกว่า 20%',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition', 'enemy_alive', 'hero_burning', 'hero_poisoned', 'hero_frozen', 'hp_less', 'turn_gte'],
    requiredBlocks: ['condition', 'enemy_alive', 'hero_burning', 'hero_poisoned', 'hero_frozen', 'hp_less', 'turn_gte'],
    enemy: {
      id: 'ancient_dragon', name: 'Ancient Dragon', spriteId: 'enemy_boss',
      budgetPerTurn: 3,
      stats: { maxHP: 800, currentHP: 800, attack: 55, defense: 28, speed: 14, armor: 18, parry: 30, enrageThreshold: 40, ailmentType: 'burn', ailmentChance: 0.45 },
      behaviors: ['burn_strike', 'attack', 'poison_strike', 'cast_spell', 'freeze_strike', 'power_strike', 'heal', 'attack', 'burn_strike'],
    },
    unlockRequirements: { levelRequired: 28, previousLevelComplete: true },
    rewards: { experience: 7000, gold: 900 },
  },

  {
    id: 'level_30', number: 30,
    name: 'Grand Architect',
    description: 'ปวส. Final Boss — Void Emperor บทพิสูจน์ขั้นสุดท้ายของนักศึกษา ปวส.',
    difficultyEstimate: 5,
    concept: 'ปวส. Final: Complete Mastery',
    tutorialText: 'Void Emperor ไม่มีจุดอ่อน — นี่คือบทพิสูจน์สุดท้ายของ ปวส.! ออกแบบ Flowchart ที่สมบูรณ์แบบที่สุดของตัวคุณเอง ผสมทุก concept ทุก skill ให้ชนะ Grand Architect!',
    objectives: ['สังหาร Void Emperor', 'แสดงว่าเข้าใจ Algorithm อย่างสมบูรณ์'],
    bonusObjective: 'HP เหลือมากกว่า 25%',
    allowedBlocks: ['attack', 'heal', 'dodge', 'cast_spell', 'power_strike', 'condition'],
    requiredBlocks: [],
    enemy: {
      id: 'void_emperor', name: 'Void Emperor', spriteId: 'enemy_boss',
      budgetPerTurn: 4,
      stats: { maxHP: 1000, currentHP: 1000, attack: 60, defense: 32, speed: 16, armor: 22, parry: 35, enrageThreshold: 40, ailmentType: 'burn', ailmentChance: 0.55 },
      behaviors: ['burn_strike', 'power_strike', 'cast_spell', 'attack', 'poison_strike', 'power_strike', 'freeze_strike', 'cast_spell', 'burn_strike', 'power_strike'],
    },
    unlockRequirements: { levelRequired: 29, previousLevelComplete: true },
    rewards: { experience: 10000, gold: 1500 },
  },
];
