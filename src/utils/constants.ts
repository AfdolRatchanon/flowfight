...
export const LEVELS = [
  ...
  },
  {
    ...
    enemy: { id: 'goblin_knight', name: 'Goblin Knight', spriteId: 'enemy_goblin', stats: { maxHP: 90, currentHP: 90, attack: 12, defense: 7, speed: 6 }, behaviors: ['attack', 'attack', 'heal'] },
  ...
  },
  {
    ...
    enemy: { id: 'orc', name: 'Orc Warrior', spriteId: 'enemy_orc', stats: { maxHP: 110, currentHP: 110, attack: 14, defense: 8, speed: 5 }, behaviors: ['attack', 'attack'] },
  ...
  },
  {
    ...
    enemy: { id: 'troll', name: 'Stone Troll', spriteId: 'enemy_troll', stats: { maxHP: 160, currentHP: 160, attack: 18, defense: 10, speed: 4 }, behaviors: ['attack', 'heal', 'attack'] },
  ...
  },
  {
    ...
    enemy: { id: 'orc_warlord', name: 'Orc Warlord', spriteId: 'enemy_orc', stats: { maxHP: 200, currentHP: 200, attack: 22, defense: 12, speed: 7 }, behaviors: ['attack', 'attack', 'cast_spell'] },
  ...
  },
  {
    ...
    enemy: { id: 'ice_giant', name: 'Ice Giant', spriteId: 'enemy_ice_giant', stats: { maxHP: 230, currentHP: 230, attack: 26, defense: 14, speed: 6 }, behaviors: ['attack', 'attack', 'cast_spell'] },
  ...
  },
  {
    ...
    enemy: { id: 'lich', name: 'Lich Lord', spriteId: 'enemy_lich', stats: { maxHP: 350, currentHP: 350, attack: 35, defense: 18, speed: 11 }, behaviors: ['cast_spell', 'attack', 'cast_spell', 'attack', 'heal'] },
  ...
  },
  {
    ...
    enemy: { id: 'shadow_demon', name: 'Shadow Demon', spriteId: 'enemy_shadow', stats: { maxHP: 400, currentHP: 400, attack: 38, defense: 20, speed: 14 }, behaviors: ['attack', 'cast_spell', 'attack', 'cast_spell', 'heal'] },
  ...
  },
  {
    ...
    enemy: { id: 'overlord', name: 'Dark Overlord', spriteId: 'enemy_boss', stats: { maxHP: 500, currentHP: 500, attack: 45, defense: 25, speed: 15 }, behaviors: ['attack', 'cast_spell', 'heal', 'cast_spell', 'attack', 'attack'] },
